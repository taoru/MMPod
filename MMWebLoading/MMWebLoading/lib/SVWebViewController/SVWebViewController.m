...
- (void)loadView {
 //   self.view.frame.origin.y=self.view.frame.origin.y+44;
    mainWebView = [[UIWebView alloc] initWithFrame:CGRectMake(0, 44, 320, 480-44-44)];
...
//    [backButton setBackgroundImage :[ UIImage  imageNamed : @"icon_back_content@2x~iphone.png" ]
...
//    
//    
//    UIBarButtonItem *fooBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:backButton];
//    self.navigationItem.leftBarButtonItem = fooBarButtonItem;
...
-(void)DownListbackViewButtonClick{
...
- (void)updateToolbarItems {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
      ...
      //  toolbar.backgroundColor=[UIColor colorWithRed:186/255.0f green:0/255.0f  blue:17/255.0f  alpha:1];
        toolbar.items = items;
